...
const StockCommentForm = ({ symbol, handleComment }: Props) => {
  ...
  return (
    <form className="mt-4 ml-4" onSubmit={handleSubmit(handleComment)}>
      ...
      <button
        type="submit"
        className="inline-flex items-center py-2.5 px-4 text-xs font-medium text-center text-white bg-lightRed rounded-lg focus:ring-4 focus:ring-primary-200 dark:focus:ring-primary-900 hover:bg-primary-800"
      >
        Post comment
      </button>
    </form>
